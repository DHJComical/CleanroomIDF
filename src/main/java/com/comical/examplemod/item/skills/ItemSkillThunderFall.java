        ...
        if (evt.getSource() == DamageSource.FALL && hurtOne instanceof EntityPlayer)
        {
            ...
            if (stack != ItemStack.EMPTY)
            {
                ...
                if (!player.world.isRemote) {
                    ...
                    List<EntityLivingBase> list = player.world.getEntitiesWithinAABB(EntityLivingBase.class, IDLGeneral.ServerAABB(mypos.add(-range, -range - hurtOne.getEyeHeight(), -range), mypos.add(range, range, range)));
