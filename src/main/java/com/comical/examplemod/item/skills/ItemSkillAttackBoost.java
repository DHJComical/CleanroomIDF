    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn) {
        ...
        if (isStackReady(playerIn, stack))
        {
            if (!worldIn.isRemote)
            {
                ...
                List<EntityLivingBase> entities = worldIn.getEntitiesWithinAABB(EntityLivingBase.class, IDLGeneral.ServerAABB(basePos.add(-base_range, -base_range, -base_range), basePos.add(base_range, base_range, base_range)));
