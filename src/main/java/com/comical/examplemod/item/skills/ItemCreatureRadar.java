...
public class ItemCreatureRadar extends ItemSkillBase {
    ...
    private String msgKey = "examplemod.msg.radar_nearbycreatures";
...
//        Entity entity = EntityList.createEntityByIDFromName(resourcelocation, worldIn);
    ...
    public void onUpdate(ItemStack stack, World worldIn, Entity entityIn, int itemSlot, boolean isSelected) {
        ...
        if (!worldIn.isRemote)
        {
            ...
            {
                //Main.Log(String.format("[Active]Nearby %s -> %s" , entity.getName() ,entity.getAttackTarget()));
                if (entity.getClass() == s && entity != entityIn)
                {
                    detection++;
                    //Main.Log("[Active]Detected!");
                }
            }
