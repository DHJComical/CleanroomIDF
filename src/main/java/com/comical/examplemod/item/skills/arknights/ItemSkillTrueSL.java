package com.comical.examplemod.item.skills.arknights;
...
public class ItemSkillTrueSL extends ItemArknightsSkillBase {
    ...
    public void playerSlash(EntityPlayer player, int level)
    {
        ...
        if (world.isRemote)
        {
            ...
            List<EntityLivingBase> entities = world.getEntitiesWithinAABB(EntityLivingBase.class, IDLGeneral.ServerAABB(basePos.add(-base_range, -base_range, -base_range), basePos.add(base_range, base_range, base_range)));
