...
import com.comical.examplemod.entity.projectiles.ProjectileArgs;
...
//    }
    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn) {
        ...
        if (!worldIn.isRemote)
        {
            ...
            //todo: optimize
            //playerIn.openGui(Main.instance, ModGuiElementLoader.GUI_DEMO, worldIn, pos.getX(), pos.getY(), pos.getZ());
...
//            }
        ...
        //Main.Log("NBT len = %d", IDLNBTUtil.GetString(stack, "TEST", "").length());
