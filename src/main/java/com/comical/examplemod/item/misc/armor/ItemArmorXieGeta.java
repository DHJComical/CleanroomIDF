package com.comical.examplemod.item.misc.armor;

import java.util.List;

import com.comical.examplemod.item.IGuaEnhance;
import com.comical.examplemod.item.ItemArmorBase;
...
public class ItemArmorXieGeta extends ItemArmorBase implements IGuaEnhance {
    ...
    public static void onCreatureHurt(LivingHurtEvent evt) {
        ...
        if (onFoot.getItem() instanceof ItemArmorXieGeta)
        {
            ...
            //Main.Log("Xie Geta dmg reduction:%s", reduction);
    ...
    {
        int mode = IDLNBTUtil.GetInt(stack, IDLNBTDef.MODE);
        return stack.getTranslationKey() + ".desc." + String.valueOf(mode);
    }
}
