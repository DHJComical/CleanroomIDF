package com.comical.examplemod.item.misc;

import java.util.List;

import com.google.common.collect.Multimap;
import com.comical.examplemod.item.IGuaEnhance;
import com.comical.examplemod.item.ItemSwordBase;
import com.comical.examplemod.util.CommonDef;
import com.comical.examplemod.util.IDLGeneral;
...
//    }
    ...
    public boolean hitEntity(ItemStack stack, EntityLivingBase target, EntityLivingBase attacker)
    {
        ...
        if (!worldIn.isRemote)
        {
            ...
            List<EntityLivingBase> entities = worldIn.getEntitiesWithinAABB(target.getClass(), IDLGeneral.ServerAABB(basePos.add(-base_range, -base_range, -base_range), basePos.add(base_range, base_range, base_range)));
...
//    public com.comical.examplemod.item.skills.martial.BuffTuple GetWaterBuff(ItemStack stack)
//    {
//        int water = GetGuaEnhance(stack, 2);
//        return new com.comical.examplemod.item.skills.martial.BuffTuple(water / 4, TICK_PER_SECOND * water * 2);
//    }
//
//    public com.comical.examplemod.item.skills.martial.BuffTuple GetMountainBuff(ItemStack stack)
//    {
//        int gua = GetGuaEnhance(stack, 4);
//        return new com.comical.examplemod.item.skills.martial.BuffTuple(gua / 4, TICK_PER_SECOND * gua * 2);
//    }
//
