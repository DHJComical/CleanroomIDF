...
import static com.comical.examplemod.util.NBTStrDef.IDLNBTDef.ASSIGNED_BLOCK_NAME;
...
public class ItemDigGoblet extends ItemGobletBase {
    ...
    public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag flag) {
        ...
        String blockDesc = I18n.format( stack.getTranslationKey() +  ".desc2", GetStoredBlockName(stack));
