package com.comical.examplemod;

import com.comical.examplemod.gui.ModGuiElementLoader;
import com.comical.examplemod.init.ModConfig;
import com.comical.examplemod.init.ModRecipes;
import com.comical.examplemod.init.ModSpawn;
import com.comical.examplemod.init.RegistryHandler;
import com.comical.examplemod.keys.KeyboardManager;
import com.comical.examplemod.meta.MetaUtil;
import com.comical.examplemod.network.NetworkHandler;
import com.comical.examplemod.proxy.ProxyBase;
...
public class Main {
    ...
    public void preInit(FMLPreInitializationEvent event) {
        ...
        if (Reference.CLIENT_PROXY_CLASS.indexOf("comical.examplemod.proxy.ClientProxy") > 0)
        {
