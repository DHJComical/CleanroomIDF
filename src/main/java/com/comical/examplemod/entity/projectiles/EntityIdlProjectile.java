package com.comical.examplemod.entity.projectiles;
...
//    }
    ...
    {
        //Main.Log("Bullet pos update:%s", getPositionEyes(0));
    ...
    protected boolean isFireballFiery()
    {
        if (args == null)
        {
            //Main.LogWarning("Args not found for bullet");
            return false;
        }
        return args.burning;
    }
...
//    }
    ...
    {
        //Main.Log("bullet impact %s", getUniqueID());
