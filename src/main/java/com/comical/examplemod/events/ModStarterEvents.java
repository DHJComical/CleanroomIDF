package com.comical.examplemod.events;
...
public class ModStarterEvents {
	  ...
	  public static void onPlayerLoggedIn(PlayerEvent.PlayerLoggedInEvent event) {
		  ...
		  //Main.Log(getPlyrIdlTagSafe(player).toString());
...
//				  CommonFunctions.SendMsgToPlayerStyled((EntityPlayerMP)player, "examplemod.msg.starter_kit_given", TextFormatting.AQUA);
//			  }
