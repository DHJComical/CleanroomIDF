package com.comical.examplemod.potion;

import java.util.Collection;

import com.comical.examplemod.potion.buff.BasePotion;
...
//            }
            ...
            if (!(trueSource instanceof EntityPlayer)) {//Players have their own critical judgement system. Now we add the non-player system.
                ...
                if (isCritical) {
                    ...
                    //Main.Log(String.format("%s:isCrit = %s, x%s =%s, ", trueSource.getName(), isCritical, critDmg, evt.getAmount()));
                }
                //Main.Log(String.format("%s:isCrit = %s, x1f =%s, ", trueSource.getName(), isCritical, evt.getAmount()));
            }
        }
