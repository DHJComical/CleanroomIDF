package com.comical.examplemod.util.NBTStrDef;
...
public class IDLNBTDef {
	...
	public static final String NAME_OFF= "examplemod.shared.off";
	public static final String NAME_ON= "examplemod.shared.on";
	...
	public static final String STARTER_KIT_VERSION_TAG = "last_starter_kit_" + Main.MODID;
	...
	//gua socket
	public static final String GUA_NO_FREE_SOCKET_DESC = "examplemod.gua_enhance_no_free.desc";
	public static final String GUA_FREE_SOCKET_DESC = "examplemod.gua_enhance_free.desc";
	public static final String GUA_TOTAL_SOCKET_DESC = "examplemod.gua_enhance_total.desc";
	public static final String GUA_N_A_DESC = "examplemod.gua_not_applicable.desc";
	...
	public static final String KILL_COUNT_DESC = "examplemod.kill_count.desc";
