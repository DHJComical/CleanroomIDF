...
public class ModConfig {
    ...
    @Config.LangKey("configgui.examplemod.category.Menu0.GeneralConf")
    @Config.Comment("Main general config.")
    public static final GeneralConf GeneralConf = new GeneralConf();

    public static class GeneralConf {
//        @Config.LangKey("examplemod.conf.general.welcome")
//        @Config.Comment("The text shown when a player logs in. Can be a key or a string.")
//        public String WELCOME_MSG = "examplemod.msg.welcome";
    }

    @Config.LangKey("configgui.examplemod.category.Menu0.DebugConf")
    ...
    @Config.LangKey("configgui.examplemod.category.Menu0.SpawnConf")
